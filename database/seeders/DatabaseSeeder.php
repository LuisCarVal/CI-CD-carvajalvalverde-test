...
class DatabaseSeeder extends Seeder
{
    private $movies=array(
        ...
        array(
            ...
            'poster' => 'https://www.alohacriticon.com/wp-content/uploads/2020/03/uno-de-los-nuestros-cartel-critica-pelicula.jpg',
            'rented' => false,
    ...
    public function run(): void
    {
        ...
        self::seedCatalog();
        self::seedUsers();
        $this->command->info("TABLE MOVIE INITIALIZED");
    }
